...
public class DoubleParser : INumericParser<double>
{
    ...
    public bool TryParse(string input, NumberStyles style, IFormatProvider? formatProvider, out double result) => double.TryParse(input.Replace(',', '.'), style, formatProvider, out result);
