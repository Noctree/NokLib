...
public class SByteParserTest
{
    ...
    [TestMethod]
    public void Overflow() => Assert.AreEqual(false, FastSByteParser.TryParseS("128", out sbyte _));

    [TestMethod]
    public void Underflow() => Assert.AreEqual(false, FastSByteParser.TryParseS("-129", out sbyte _));
    ...
    [TestMethod]
    public void InvalidInput() => Assert.AreEqual(false, FastSByteParser.TryParseS("hello World", out sbyte _));
}
