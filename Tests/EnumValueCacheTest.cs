...
namespace NokLib
{
    ...
    public class EnumValueCacheTest
    {
        ...
        public void IsDefined() {
            Assert.IsTrue(EnumValueCache<ConsoleColor>.IsDefined(ConsoleColor.Red.ToInt()));
        }

        [TestMethod]
        public void IsNotDefined() {
            Assert.IsFalse(EnumValueCache<ConsoleColor>.IsDefined(69));
        }
        ...
        [TestMethod]
        public void TryNotParse() {
            Assert.IsFalse(EnumValueCache<ConsoleColor>.TryParse("bruh", out var color));
        }
